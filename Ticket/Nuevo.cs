    ...
    public partial class Nuevo : Form
    {
        ...
        private void comporta(int i)
        {
            ...
            if (i == 1)
            {
                ...
                cmbClase.DataSource = aux1;
                cmbClase.ValueMember = "id";
                cmbClase.DisplayMember = "nombre";
                cmbClase.AutoCompleteCustomSource = autocompleta(aux1);
        ...
        public AutoCompleteStringCollection autocompleta(DataTable algo)
        {
            AutoCompleteStringCollection stringCol = new AutoCompleteStringCollection();
            foreach (DataRow row in algo.Rows)
            {
